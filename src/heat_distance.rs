pub fn direction_gradient_on_surface (
    tri2dir: &mut [f32],
    tri2vtx: &[usize],
    vtx2xyz: &[f32],
    vtx2heat: &[f32]) {
    assert_eq!(tri2dir.len(), tri2vtx.len());
    for i_tri in 0..tri2vtx.len() / 3 {
        ...
        tri2dir[i_tri * 3 + 0] = g0[0] * vtx2heat[i0] + g1[0] * vtx2heat[i1] + g2[0] * vtx2heat[i2];
        tri2dir[i_tri * 3 + 1] = g0[1] * vtx2heat[i0] + g1[1] * vtx2heat[i1] + g2[1] * vtx2heat[i2];
        tri2dir[i_tri * 3 + 2] = g0[2] * vtx2heat[i0] + g1[2] * vtx2heat[i1] + g2[2] * vtx2heat[i2];
        normalize(&mut tri2dir[i_tri * 3..i_tri * 3 + 3]);
    }
}
...
pub fn divergence_on_trimesh3(
    ...
    for i_tri in 0..tri2vtx.len() / 3 {
        ...
        let x = &tri2dir[i_tri * 3..i_tri * 3 + 3];
